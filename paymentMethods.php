...
<html lang="en">
  <head>
    ...
    <link href="css/nav_paymentMethods.css" rel="stylesheet" />
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="market.php"
                >Home</a
              >
            </li>
        ...
        <div class="col-lg-4 mb-lg-0 mb-3">
          <div class="card p-3">
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              >
              <small
                ><span class="fw-bold">Name:</span><span>Kumar</span></small
              >
            </div>
          </div>
        </div>
